...
```{r, fig.align='center', fig.alt= "Change nav bar", echo = FALSE}
...
```{r, fig.align='center', fig.alt= "Change theme", echo = FALSE}
...
```{r, fig.align='center', fig.alt= "Change color of line", echo = FALSE}
...
Also checkout the [R Markdown cheatsheet]( https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf) for more custimatization of the pages.
