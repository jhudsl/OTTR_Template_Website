...
```{r, fig.align='center', fig.alt= "Clicking on settings", echo = FALSE}
...
```{r, fig.align='center', fig.alt= "adding main branch rule", echo = FALSE}
...
```{r, fig.align='center', fig.alt= "modify branch rules", echo = FALSE}
